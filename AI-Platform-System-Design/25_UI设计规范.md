...
| Agents | `/agents` | 🔲 占位 | 待实现 |
| Knowledge | `/knowledge` | 🔲 占位 | 待实现 |
| Documents | `/documents` | 🔲 占位 | 待实现 |
| Workflow | `/workflow` | 🔲 占位 | 待实现 |
| Research | `/research` | 🔲 占位 | 待实现 |
| Models | `/models` | 🔲 占位 | 待实现 |
| Vector DB | `/vector-db` | 🔲 占位 | 待实现 |
